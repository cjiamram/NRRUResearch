...
<head>
  ...
  <title>ระบบสารสนเทศงานวิจัยมหาวิทยาลัยราชภัฏนครราชสีมา</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <!-- Logo -->
    <a href="#" class="logo">
      <span class="logo-mini"><b>RDI</b></span>
      <span class="logo-lg"><b>NRRU RDI</b></span>
    </a>
...
(async () => {
  ...
  function initialize(){
    ...
    //$("#dvMain").load("<?=$rootPath?>/tregister/registerInput.php");
  }
