...
class Menu{
	 private $conn;
      ...
      private function hadPrivillage($UserId){
         $query="SELECT UserId FROM t_previllage 
         WHERE UserId=:UserId";
      ...
      public function setPrivillageDefault($UserId){
         if($this->hadPrivillage($UserId)<=0){
               $query="INSERT INTO t_previllage(UserId,MenuId)
      ...
      public function getHeadMenu($UserId){
         $query="SELECT
            ...
            B.LevelNo,
            B.icon 
         FROM t_previllage A INNER JOIN t_menu B ON 
      ...
      public function listMenu($UserId){
            ...
            B.LevelNo,
            B.PrettyLink 
         FROM t_previllage A INNER JOIN 
         t_menu B ON 
         A.MenuId=B.MenuId 
